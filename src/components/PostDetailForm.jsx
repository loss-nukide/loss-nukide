  ...
  return (
    <div id="post-detail-form" className="page">
      ...
      <input
        type="text"
        value={noodlesType}
        onChange={(e) => setNoodlesType(e.target.value)}
        placeholder="ラーメンの麺量を入力"
      />
      <input
        type="text"
        value={vegetableType}
      ...
      <input
        type="text"
        value={garlicType}
        onChange={(e) => setGarlicType(e.target.value)}
        placeholder="ニンニクの量を入力"
      />
      <input
        type="text"
        value={karameType}
        onChange={(e) => setKarameType(e.target.value)}
        placeholder="カラメの量を入力"
      />
      <input
        type="text"
        value={aburaType}
        onChange={(e) => setAburaType(e.target.value)}
        placeholder="アブラの量を入力"
      />
      <textarea
        value={postContent}
